  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="w-full max-w-2xl mx-auto px-6 py-10">
        ...
        {/* Download button */}
        <a
          href="https://github.com/Stage-11-Agentics/c11/releases/download/nightly/c11-nightly-macos.dmg"
        ...
        >
          {t.rich("warning", {
            githubLink: (chunks) => (
              <a
                href="https://github.com/Stage-11-Agentics/c11/issues"
                target="_blank"
